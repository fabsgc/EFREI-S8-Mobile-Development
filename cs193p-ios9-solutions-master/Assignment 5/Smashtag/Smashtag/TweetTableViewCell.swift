...
class TweetTableViewCell: UITableViewCell
{
    ...
    private func getColorfulTextLabel(tweet: Twitter.Tweet) -> NSMutableAttributedString {
        var text = tweet.text
    ...
    private func getCreatedLabel(tweet: Twitter.Tweet) -> String {
...
private extension NSMutableAttributedString {
    func setMensionsColor(mensions: [Twitter.Mention], color: UIColor) {
